...
class Config:
    ...
    def __init__(self):
        ...
        self.SUPPORT_CHANNEL: str = getenv(
            "SUPPORT_CHANNEL", "https://t.me/aarav_info")
        self.SUPPORT_CHAT: str = getenv("SUPPORT_CHAT", "https://t.me/gufudfhj")
        ...
        self.PING_IMG: str = getenv(
            "PING_IMG", "https://i.ibb.co/jPb46fkc/x.jpg")    # Ping command image
        self.START_IMG: str = getenv(
            "START_IMG", "https://i.ibb.co/jPb46fkc/x.jpg")  # Start command image
        self.RADIO_IMG: str = getenv(
            "RADIO_IMG", "https://i.ibb.co/jPb46fkc/x.jpg")    # Radio command image
